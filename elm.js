...
var $author$project$Main$expenseDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Main$ExpenseItem,
		...
		switch (msg.$) {
			...
			case 'Delete':
				...
				var updatedExpenseItems1 = A2(
					...
					model.expenseItems);
				var _v1 = $elm$core$List$head(updatedExpenseItems2);
				if (_v1.$ === 'Just') {
					var x = _v1.a;
			...
			case 'Edit':
				...
				var _v2 = $elm$core$List$head(updatedExpenseItems2);
				if (_v2.$ === 'Just') {
					var x = _v2.a;
					var expenseItem = A3($author$project$Main$ExpenseItem, x.index, x.expenseItem, x.expenseAmount);
			...
			case 'CancelEdit':
				...
				var listTail = A2($elm$core$List$drop, index + 1, model.expenseItems);
				var listHead = A2($elm$core$List$take, index, model.expenseItems);
				var _v3 = $elm$core$List$head(updatedExpenseItems2);
				if (_v3.$ === 'Just') {
					var x = _v3.a;
					var expenseItem = A3($author$project$Main$ExpenseItem, x.index, x.expenseItem, x.expenseAmount);
					var updatedExpenseItems = _Utils_ap(
...
var $author$project$Main$viewExpenseItem = function (expenseItem) {
	return A2(
		$elm$html$Html$tr,
		_List_Nil,
		_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_Utils_ap(
							...
							A2($elm$core$List$map, $author$project$Main$viewExpenseItem, model.expenseItems)))
					]))
			]));
};
